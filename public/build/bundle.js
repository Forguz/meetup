    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 24, 2, 356);
    			attr_dev(header, "class", "svelte-cbgezr");
    			add_location(header, file$3, 23, 0, 345);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p1, file$2, 73, 4, 1061);
    			attr_dev(div1, "class", "content svelte-8tjse");
    			add_location(div1, file$2, 72, 2, 1035);
    			attr_dev(a, "href", a_href_value = "mailto:" + /*email*/ ctx[5]);
    			add_location(a, file$2, 76, 4, 1106);
    			add_location(button0, file$2, 77, 4, 1147);
    			add_location(button1, file$2, 78, 4, 1181);
    			attr_dev(footer, "class", "svelte-8tjse");
    			add_location(footer, file$2, 75, 2, 1093);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 27, 0, 1091);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
